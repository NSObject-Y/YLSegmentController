...
public class YLSegmentSliderController: UIView {
            ...
            if self.childsViewControllers != nil{
                    if self.segmentType == .Navigation{
                        if segmentContent == nil {
                            ...
                            self.segmentContent = YLSegmentContentController.init(frame: frame, childVcs: self.childsViewControllers!, parentViewController: self.hostViewController)
    ...
    var segmentContent: YLSegmentContentController?
    public var  segmentSilder_height:CGFloat?
